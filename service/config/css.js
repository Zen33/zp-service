...
const genStyleRules = () => {
  ...
  return [
    ...
    createCSSRule(/\.styl(us)?$/, 'stylus-loader', config.cssLoaderOptions && config.cssLoaderOptions['stylus-loader'] || {}),
    createCSSRule(/\.scss$/, 'sass-loader', config.cssLoaderOptions && config.cssLoaderOptions['sass-loader'] || {})
  ]
}

module.exports = {
  plugins,
  module: { rules: genStyleRules() }
}
